...
from darknet_sit import Darknet
...
# blocks = darknet.parse_cfg("/root/labs/lab4/cfg/yolov3.cfg")
...
# print(write_results(pred, 0.5, 80, nms_conf = 0.4))

# num_classes = 80
# classes = load_classes("data/coco.names")
# print(classes)

images = "Lab04/cocoimages"
batch_size = 4
confidence = 0.5
nms_thesh = 0.4
start = 0
